---
title: "Sobre"
description: "Conheça a equipe editorial do Ponta Market, a origem dos dados e os critérios aplicados às análises de EA FC."
---

O **Ponta Market** é uma publicação editorial especializada em EA FC Ultimate Team. Nosso foco é claro: As melhores pontas do EA FC Ultimate Team: preços e mercado, todos os dias.

## Quem assina

As publicações são assinadas por **Ponta Market**. O sistema organiza dados de mercado, produz tabelas e aplica regras editoriais reproduzíveis antes de liberar cada análise. Dúvidas, correções e sugestões podem ser enviadas para [contato@futquant.com](mailto:contato@futquant.com).
